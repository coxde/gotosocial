...
type GoToSocialApprovalRequiredProperty interface {
	...
	// of a list of the property "approvalRequired". Invalidates iterators
	...
	// the back of a list of the property "approvalRequired". Invalidates
	...
	// value to the back of a list of the property "approvalRequired".
	...
	// "approvalRequired". Invalidates iterators that are traversing using
	// Prev.
	...
	// specified index for a property "approvalRequired". Existing
	...
	// the specified index for a property "approvalRequired". Existing
	// elements at that index and higher are shifted back once.
	// Invalidates all iterators.
	...
	// value at the specified index for a property "approvalRequired".
	...
	// PrependType prepends an arbitrary type value to the front of a list of
	// the property "approvalRequired". Invalidates all iterators. Returns
	...
	// the front of a list of the property "approvalRequired". Invalidates
	// all iterators.
	...
	// "approvalRequired". Invalidates all iterators.
	...
	// specified index for the property "approvalRequired". Panics if the
	// index is out of bounds. Invalidates all iterators.
	...
	// the specified index for the property "approvalRequired". Panics if
	...
	// be at the specified index for the property "approvalRequired".
	...
	// property "approvalRequired". Invalidates all iterators. Returns an
