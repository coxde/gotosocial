...
type GoToSocialAlwaysProperty interface {
	...
	// the back of a list of the property "always". Invalidates iterators
	...
	// value to the back of a list of the property "always". Invalidates
	...
	// "always". Invalidates iterators that are traversing using Prev.
	...
	// specified index for a property "always". Existing elements at that
	...
	// the specified index for a property "always". Existing elements at
	...
	// value at the specified index for a property "always". Existing
	...
	// PrependType prepends an arbitrary type value to the front of a list of
	// the property "always". Invalidates all iterators. Returns an error
	...
	// the front of a list of the property "always". Invalidates all
	// iterators.
	...
	// value to the front of a list of the property "always". Invalidates
	// all iterators.
	...
	// "always". Invalidates all iterators.
	...
	// specified index for the property "always". Panics if the index is
	// out of bounds. Invalidates all iterators.
	...
	// the specified index for the property "always". Panics if the index
	...
	// be at the specified index for the property "always". Panics if the
	...
	// value to be at the specified index for the property "always".
	...
	// property "always". Invalidates all iterators. Returns an error if
