...
func (this GoToSocialAlwaysPropertyIterator) GetActivityStreamsCollection() vocab.ActivityStreamsCollection {
...
func (this GoToSocialAlwaysPropertyIterator) GetActivityStreamsCollectionPage() vocab.ActivityStreamsCollectionPage {
...
func (this GoToSocialAlwaysPropertyIterator) GetActivityStreamsOrderedCollection() vocab.ActivityStreamsOrderedCollection {
...
func (this GoToSocialAlwaysPropertyIterator) GetActivityStreamsOrderedCollectionPage() vocab.ActivityStreamsOrderedCollectionPage {
...
func (this GoToSocialAlwaysPropertyIterator) GetType() vocab.Type {
...
func (this GoToSocialAlwaysPropertyIterator) IsActivityStreamsCollection() bool {
...
func (this GoToSocialAlwaysPropertyIterator) IsActivityStreamsCollectionPage() bool {
...
// property.
func (this GoToSocialAlwaysPropertyIterator) IsActivityStreamsOrderedCollection() bool {
...
// property.
func (this GoToSocialAlwaysPropertyIterator) IsActivityStreamsOrderedCollectionPage() bool {
...
func (this *GoToSocialAlwaysPropertyIterator) SetActivityStreamsCollection(v vocab.ActivityStreamsCollection) {
	this.clear()
...
func (this *GoToSocialAlwaysPropertyIterator) SetActivityStreamsCollectionPage(v vocab.ActivityStreamsCollectionPage) {
	this.clear()
...
func (this *GoToSocialAlwaysPropertyIterator) SetActivityStreamsOrderedCollection(v vocab.ActivityStreamsOrderedCollection) {
	this.clear()
...
func (this *GoToSocialAlwaysPropertyIterator) SetActivityStreamsOrderedCollectionPage(v vocab.ActivityStreamsOrderedCollectionPage) {
	this.clear()
...
func (this *GoToSocialAlwaysPropertyIterator) SetType(t vocab.Type) error {
	...
	return fmt.Errorf("illegal type to set on GoToSocialAlways property: %T", t)
}
...
// list of the property "always". Invalidates iterators that are traversing
// using Prev.
func (this *GoToSocialAlwaysProperty) AppendActivityStreamsCollection(v vocab.ActivityStreamsCollection) {
...
// of a list of the property "always". Invalidates iterators that are
// traversing using Prev.
func (this *GoToSocialAlwaysProperty) AppendActivityStreamsCollectionPage(v vocab.ActivityStreamsCollectionPage) {
	this.properties = append(this.properties, &GoToSocialAlwaysPropertyIterator{
		activitystreamsCollectionPageMember: v,
		alias:                               this.alias,
		myIdx:                               this.Len(),
...
// back of a list of the property "always". Invalidates iterators that are
// traversing using Prev.
func (this *GoToSocialAlwaysProperty) AppendActivityStreamsOrderedCollection(v vocab.ActivityStreamsOrderedCollection) {
	this.properties = append(this.properties, &GoToSocialAlwaysPropertyIterator{
		activitystreamsOrderedCollectionMember: v,
		alias:                                  this.alias,
		myIdx:                                  this.Len(),
...
// value to the back of a list of the property "always". Invalidates iterators
// that are traversing using Prev.
func (this *GoToSocialAlwaysProperty) AppendActivityStreamsOrderedCollectionPage(v vocab.ActivityStreamsOrderedCollectionPage) {
	this.properties = append(this.properties, &GoToSocialAlwaysPropertyIterator{
		activitystreamsOrderedCollectionPageMember: v,
		alias:  this.alias,
		myIdx:  this.Len(),
...
func (this *GoToSocialAlwaysProperty) AppendType(t vocab.Type) error {
	n := &GoToSocialAlwaysPropertyIterator{
		alias:  this.alias,
		myIdx:  this.Len(),
		parent: this,
	}
...
// index for a property "always". Existing elements at that index and higher
// are shifted back once. Invalidates all iterators.
func (this *GoToSocialAlwaysProperty) InsertActivityStreamsCollection(idx int, v vocab.ActivityStreamsCollection) {
...
// specified index for a property "always". Existing elements at that index
// and higher are shifted back once. Invalidates all iterators.
func (this *GoToSocialAlwaysProperty) InsertActivityStreamsCollectionPage(idx int, v vocab.ActivityStreamsCollectionPage) {
	this.properties = append(this.properties, nil)
	copy(this.properties[idx+1:], this.properties[idx:])
	this.properties[idx] = &GoToSocialAlwaysPropertyIterator{
		activitystreamsCollectionPageMember: v,
...
// specified index for a property "always". Existing elements at that index
// and higher are shifted back once. Invalidates all iterators.
func (this *GoToSocialAlwaysProperty) InsertActivityStreamsOrderedCollection(idx int, v vocab.ActivityStreamsOrderedCollection) {
	this.properties = append(this.properties, nil)
	copy(this.properties[idx+1:], this.properties[idx:])
	this.properties[idx] = &GoToSocialAlwaysPropertyIterator{
		activitystreamsOrderedCollectionMember: v,
...
// value at the specified index for a property "always". Existing elements at
// that index and higher are shifted back once. Invalidates all iterators.
func (this *GoToSocialAlwaysProperty) InsertActivityStreamsOrderedCollectionPage(idx int, v vocab.ActivityStreamsOrderedCollectionPage) {
	this.properties = append(this.properties, nil)
	copy(this.properties[idx+1:], this.properties[idx:])
	this.properties[idx] = &GoToSocialAlwaysPropertyIterator{
		activitystreamsOrderedCollectionPageMember: v,
...
// PrependType prepends an arbitrary type value to the front of a list of the
// property "always". Invalidates all iterators. Returns an error if the type
// is not a valid one to set for this property.
func (this *GoToSocialAlwaysProperty) InsertType(idx int, t vocab.Type) error {
	n := &GoToSocialAlwaysPropertyIterator{
		alias:  this.alias,
		myIdx:  idx,
		parent: this,
...
// list of the property "always". Invalidates all iterators.
func (this *GoToSocialAlwaysProperty) PrependActivityStreamsCollection(v vocab.ActivityStreamsCollection) {
...
// front of a list of the property "always". Invalidates all iterators.
func (this *GoToSocialAlwaysProperty) PrependActivityStreamsCollectionPage(v vocab.ActivityStreamsCollectionPage) {
	this.properties = append([]*GoToSocialAlwaysPropertyIterator{{
		activitystreamsCollectionPageMember: v,
		alias:                               this.alias,
		myIdx:                               0,
...
// the front of a list of the property "always". Invalidates all iterators.
func (this *GoToSocialAlwaysProperty) PrependActivityStreamsOrderedCollection(v vocab.ActivityStreamsOrderedCollection) {
	this.properties = append([]*GoToSocialAlwaysPropertyIterator{{
		activitystreamsOrderedCollectionMember: v,
		alias:                                  this.alias,
		myIdx:                                  0,
...
// value to the front of a list of the property "always". Invalidates all
// iterators.
func (this *GoToSocialAlwaysProperty) PrependActivityStreamsOrderedCollectionPage(v vocab.ActivityStreamsOrderedCollectionPage) {
	this.properties = append([]*GoToSocialAlwaysPropertyIterator{{
		activitystreamsOrderedCollectionPageMember: v,
		alias:  this.alias,
		myIdx:  0,
...
// property "always". Invalidates all iterators. Returns an error if the type
// is not a valid one to set for this property.
func (this *GoToSocialAlwaysProperty) PrependType(t vocab.Type) error {
	n := &GoToSocialAlwaysPropertyIterator{
		alias:  this.alias,
		myIdx:  0,
		parent: this,
	...
	this.properties = append([]*GoToSocialAlwaysPropertyIterator{n}, this.properties...)
	for i := 1; i < this.Len(); i++ {
		(this.properties)[i].myIdx = i
	}
	return nil
...
// index for the property "always". Panics if the index is out of bounds.
// Invalidates all iterators.
func (this *GoToSocialAlwaysProperty) SetActivityStreamsCollection(idx int, v vocab.ActivityStreamsCollection) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &GoToSocialAlwaysPropertyIterator{
		activitystreamsCollectionMember: v,
		alias:                           this.alias,
...
// specified index for the property "always". Panics if the index is out of
// bounds. Invalidates all iterators.
func (this *GoToSocialAlwaysProperty) SetActivityStreamsCollectionPage(idx int, v vocab.ActivityStreamsCollectionPage) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &GoToSocialAlwaysPropertyIterator{
		activitystreamsCollectionPageMember: v,
		alias:                               this.alias,
...
// specified index for the property "always". Panics if the index is out of
// bounds. Invalidates all iterators.
func (this *GoToSocialAlwaysProperty) SetActivityStreamsOrderedCollection(idx int, v vocab.ActivityStreamsOrderedCollection) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &GoToSocialAlwaysPropertyIterator{
		activitystreamsOrderedCollectionMember: v,
		alias:                                  this.alias,
...
// be at the specified index for the property "always". Panics if the index is
// out of bounds. Invalidates all iterators.
func (this *GoToSocialAlwaysProperty) SetActivityStreamsOrderedCollectionPage(idx int, v vocab.ActivityStreamsOrderedCollectionPage) {
	(this.properties)[idx].parent = nil
	(this.properties)[idx] = &GoToSocialAlwaysPropertyIterator{
		activitystreamsOrderedCollectionPageMember: v,
		alias:  this.alias,
...
// "always". Invalidates all iterators. Returns an error if the type is not a
// valid one to set for this property. Panics if the index is out of bounds.
func (this *GoToSocialAlwaysProperty) SetType(idx int, t vocab.Type) error {
	n := &GoToSocialAlwaysPropertyIterator{
		alias:  this.alias,
		myIdx:  idx,
		parent: this,
